export const es = {
  ...
  home: {
    ...
    footer: {
      ...
      description:
        "OpenBacklog es un gestor de backlog de videojuegos para decidir qué jugar después y terminar más juegos con constancia.",
      usefulLinksTitle: "RECURSOS",
      usefulLinks: {
        changelog: "CHANGELOG",
        features: "ROADMAP",
        faq: "PREGUNTAS",
  ...
  changelog: {
    metaTitle: "Changelog de OpenBacklog | Actualizaciones de Producto",
    metaDescription:
      "Consulta notas de versión de OpenBacklog, mejoras del gestor de backlog y nuevas funciones para terminar más juegos.",
    title: "Changelog de OpenBacklog",
    description:
    ...
    statusBody:
      "Esta página publicará todos los cambios por versión. La estructura ya está activa y el seguimiento de versión aparece en el badge de inicio.",
    featuresLink: "VER ROADMAP",
  ...
  features: {
    ...
    suggestion: {
      ...
      modalTitle: "Enviar sugerencia al roadmap",
      modalDescription:
        "Comparte una idea concreta con contexto suficiente para evaluar impacto y coste de implementación.",
      close: "CANCELAR",
      ...
      fields: {
        emailLabel: "Correo",
        emailPlaceholder: "tu@email.com",
        titleLabel: "Título de la sugerencia",
        titlePlaceholder: "Ejemplo: Vista semanal de planificación del backlog",
        messageLabel: "Detalle de la sugerencia",
        messagePlaceholder:
          "Explica el problema, tu propuesta y por qué sería importante.",
      },
      feedback: {
        created: "Sugerencia enviada. Revisa tu correo para la confirmación.",
        createdEmailPending:
          "Sugerencia recibida. El correo de confirmación está pendiente.",
        invalidEmail: "Introduce un correo válido.",
        invalidPayload:
          "Completa título y detalle para poder revisar tu sugerencia.",
        rateLimited:
          "Demasiados intentos en poco tiempo. Vuelve a intentarlo en unos minutos.",
        genericError: "Ha ocurrido un error. Inténtalo de nuevo.",
      },
  ...
  app: {
    ...
    upcoming: {
      ...
      metaDescription:
        "Sigue lanzamientos próximos por semana actual, mes actual y lista general para planificar mejor tu backlog.",
      title: "Próximos Lanzamientos",
      description:
        "Consulta lanzamientos próximos por semana actual, mes actual y horizonte general.",
      weekLabel: "Próximos lanzamientos de esta semana",
      weekHint: "Lanzamientos desde hoy hasta el cierre de la semana actual.",
      monthLabel: "Lanzamientos destacados en {month}",
      monthHint:
        "Lanzamientos destacados desde hoy hasta el final del mes actual, excluyendo los de esta semana.",
      generalLabel: "Próximos lanzamientos generales",
      generalHint: "Siguientes lanzamientos confirmados después de este mes.",
      sectionEmpty: "Aún no hay lanzamientos confirmados en este rango.",
      fallbackTitle: "Próximos lanzamientos confirmados",
      fallbackDescription:
        "Aún no hay fechas confirmadas en este mes. Mostramos los títulos más cercanos en salir.",
      emptyTitle: "No hay destacados próximos disponibles",
      emptyBody:
        "Vuelve más tarde o usa la búsqueda para descubrir más juegos próximos.",
      emptyCta: "ABRIR BÚSQUEDA",
    },
    popular: {
      metaTitle: "Juegos Populares | OpenBacklog",
      metaDescription:
        "Explora los juegos más populares globales, lanzamientos recién activos y tendencias entre tus amigos.",
      title: "Juegos Populares",
      description:
        "Revisa rápido qué está en tendencia ahora: popularidad global, lanzamientos recientes activos, actividad entre amigos y filtros por plataforma o género.",
      sectionEmpty: "Aún no hay juegos disponibles en esta sección.",
      emptyTitle: "No hay juegos populares disponibles ahora",
      emptyBody:
        "Vuelve más tarde o usa búsqueda para añadir y descubrir más juegos.",
      emptyCta: "ABRIR BÚSQUEDA",
      sections: {
      ...
      filters: {
        ...
        description:
          "Elige plataforma o género para abrir página dedicada de ranking.",
        platformsTitle: "Plataformas",
        genresTitle: "Géneros",
        platformSingular: "plataforma",
        genreSingular: "género",
        metaTitle: "Populares por {type}: {facet} | OpenBacklog",
        metaDescription:
          "Consulta los juegos más populares para {type} {facet} según actividad actual en OpenBacklog.",
        ...
        emptyBody:
          "Prueba otro filtro o usa búsqueda para descubrir más títulos.",
      },
    },
  },
  gameDetail: {
    ...
    backHome: "VOLVER AL INICIO",
    sharePage: "COMPARTIR",
    sharedPage: "LINK COPIADO",
    shareText: "Mira este juego en OpenBacklog: {game}",
    heroBadge: "DETALLE DEL JUEGO",
    idLabel: "ID",
    friendsOwnThis: "Amigos que ya tienen este juego",
    firstReleaseDateLabel: "Primer lanzamiento",
    ratingLabel: "Puntuación",
    platformsLabel: "Plataformas",
    genresLabel: "Géneros",
    estimatedMainLabel: "Duración estimada (historia principal)",
    estimatedCompletionistLabel: "Duración estimada (completista)",
    lastSyncedLabel: "Última sincronización",
    unknownValue: "Desconocido",
    noSummary: "No hay resumen disponible para este juego.",
    similarGamesTitle: "Juegos similares",
    similarGamesDescription:
      "Más opciones de estilo y gameplay parecido para avanzar tu backlog.",
    noSimilarGames: "No hay juegos similares disponibles ahora mismo.",
    userReviewsTitle: "Reviews de usuarios",
    userReviewsDescription:
      "Lee opiniones recientes de la comunidad antes de decidir si encaja en tu backlog.",
    noUserReviews: "Aún no hay reviews públicas de este juego.",
    ...
    labels: {
      ...
      containsSpoilers: "Esta review contiene spoilers",
    },
    placeholders: {
  ...
  library: {
    ...
    filters: {
      ...
      viewToggleLabel: "Diseño",
      rowView: "Filas",
      gridView: "Grid compacto",
    ...
    update: {
      stateLabel: "Actualizar estado",
      stateHelp: "Elige estado siguiente y guarda cambio.",
      currentState: "Actual: {state}",
  ...
  legal: {
    ...
    common: {
      ...
      lastUpdated: "8 de abril de 2026",
    },
    privacy: {
      ...
      sections: [
        ...
        },
        {
          title: "Tus Derechos",
          body: [
            "Puedes solicitar acceso, rectificación o eliminación de tus datos en cualquier momento escribiendo a hello@openbacklog.app.",
          ],
        },
      ],
    },
      ...
      sections: [
        {
          ...
          body: [
            "OpenBacklog se ofrece como producto en evolución. Las funcionalidades, condiciones de acceso y disponibilidad pueden cambiar durante el desarrollo.",
          ],
        },
        {
          title: "Uso Aceptable",
          body: [
            "Aceptas no abusar de los formularios, no intentar acceso no autorizado y no interferir con la operación del sitio.",
            "La actividad automatizada o maliciosa puede bloquearse o eliminarse para proteger la fiabilidad del servicio.",
          ],
        },
        {
          title: "Propiedad Intelectual",
          body: [
            "La marca, el contenido y el software de OpenBacklog están protegidos por la legislación aplicable de propiedad intelectual, salvo que se indique lo contrario.",
          ],
        },
        {
          ...
          body: [
            ...
            "En la máxima medida permitida por la ley, OpenBacklog no será responsable de daños indirectos o consecuenciales derivados del uso del servicio.",
          ],
        },
      ],
    },
      ...
      sections: [
        {
          ...
          body: [
            "Las cookies esenciales pueden usarse para seguridad, continuidad de sesión y comportamiento relacionado con idioma.",
          ],
        },
        {
          title: "Analítica y Rendimiento",
          body: [
            "Cuando introduzcamos analítica, esta política se actualizará para describir proveedores concretos y los controles disponibles para usuarios.",
          ],
        },
        {
          title: "Gestión de Cookies",
          body: [
            "Puedes controlar o eliminar cookies desde la configuración del navegador. Bloquear cookies esenciales puede afectar al funcionamiento del sitio.",
          ],
        },
      ],
    },
